...
#[derive(Debug, Parser)]
#[command(bin_name = "opencode plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces OpenCode is currently considering and their roots.
    List,
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "opencode plugin marketplace add",
    after_help = "Examples:\n  opencode plugin marketplace add ./path/to/marketplace\n  opencode plugin marketplace add owner/repo --ref main\n  opencode plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "opencode plugin marketplace upgrade",
    after_help = "Examples:\n  opencode plugin marketplace upgrade\n  opencode plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "opencode plugin marketplace remove",
    after_help = "Example:\n  opencode plugin marketplace remove debug"
)]
