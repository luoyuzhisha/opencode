...
#[derive(Debug, Parser)]
#[command(bin_name = "opencode plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "opencode plugin add",
    after_help = "Examples:\n  opencode plugin add sample@debug\n  opencode plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "opencode plugin list",
    after_help = "Examples:\n  opencode plugin list\n  opencode plugin list --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "opencode plugin remove",
    after_help = "Examples:\n  opencode plugin remove sample@debug\n  opencode plugin remove sample --marketplace debug"
)]
