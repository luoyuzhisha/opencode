...
/// 2. The vendored bubblewrap tree under `opencode-rs/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under opencode-rs/vendor.",
        vendor_dir.display()
    ))
}
